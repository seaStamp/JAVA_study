...
class Data6_2Main {
    public static void main(String[] args) {
        ...
        System.out.println("Data6_2 클래스로 만든 data2 인스턴스의 인스턴스 변수 값 확인");
        System.out.println("data2 인스턴스 변수 x = " + data.data2.x);
        System.out.println("data2 인스턴스 변수 y = " + data.data2.y);
        System.out.println();

        // changeParameter 메서드의 매개변수에 Data 6_2 클래스의 참조형 변수인 data2를 입력한다.
        System.out.println("입력받은 매개변수의 값을 바꾸는 메서드 수행");
        changeParameter(data.data2);
        System.out.println();

        // changeParameter(Data6_3 data2); 여기서의 data.data2는
        // data의 인스턴스 참조형 변수 data2의 주소값이 넘어감.
        // 따라서 changeParameter 메서드에서 입력받은 data2의 주소값을 통해
        // data2의 인스턴스에 접근하여 인스턴스 변수를 바꾸기 때문에 영향을 받음

        System.out.println("Data6_3 클래스로 만든 data 인스턴스의 참조변수 data2의 인스턴스 변수의 값이 변경되었는지 확인");
        System.out.println("changeParameter 메서드 수행 후 data2 인스턴스 변수 x = " + data.data2.x);
        System.out.println("changeParameter 메서드 수행 후 data2 인스턴스 변수 y = " + data.data2.y);
    }
